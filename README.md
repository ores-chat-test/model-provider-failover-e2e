# model-provider-failover-e2e

Status: **contract-only**. This suite specifies policy-controlled provider routing, timeout handling, fallback, and circuit breaking.
